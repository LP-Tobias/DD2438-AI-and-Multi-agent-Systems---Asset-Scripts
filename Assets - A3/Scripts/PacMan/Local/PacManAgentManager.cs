...
namespace PacMan
{
    //TODO: Ugly code duplication with Network version, need to refactor
    public class PacManAgentManager : MonoBehaviour, IPacManAgentManager, IPacManAgent
    {
        ...
        {
            _pacManGameManager = gameObject.GetComponentInParent<PacManGameManager>();
        ...
        private PacManObservations ProducePacManObservations()
        {
            ...
            pacManObservations.Observations = doCheckVisibility
                .Select(pair =>
                {
                    ...
                    pacManObservation.Velocity = agent.GetComponent<Rigidbody>().velocity;
                    if (!pair.visible)
                    {
        ...
        {
            gameObject.transform.position = globalStartPosition;
        }
        ...
        public ObstacleMapManager GetObstacleMap()
        {
            return _pacManGameManager?.obstacleMap;
        }
    }
}